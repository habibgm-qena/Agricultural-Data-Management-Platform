...
export default function FiscoScore() {
  ...
  const [productType, setProductType] = useState("apiculture");
  const [fiscoData, setFiscoData] = useState<Array<{
    name: string;
    score: number;
  }> | null>(null);
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <CardDescription className="text-emerald-100">
                Enter a Customer ID and product type to fetch and visualize the
                FICO score
              </CardDescription>
            </div>
          </div>
      ...
      <Card className="bg-white/80 backdrop-blur-sm p-6">
        <CardContent>
          <form
            ...
            className="grid grid-cols-1 md:grid-cols-4  items-end"
          >
            <div className="md:col-span-3 space-y-2">
              ...
              <div className="">
                ...
                <div id="cropType" className="w-full">
                    <Select
                    value={productType}
                    onValueChange={(value) => setProductType(value)}
                    >
                    <SelectTrigger className="border-purple-200 focus:ring-emerald-600 focus:border-emerald-700">
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="agroprocessing">
                        AGROPROCESSING
                        </SelectItem>
